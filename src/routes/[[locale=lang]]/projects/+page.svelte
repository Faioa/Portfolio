...
<div class="container">
	...
	<p>
		This page showcases the projects I'm most proud of. More content will be added over time. You can find out more
		about each project on their respective page. For instance, you will find information about my motivations and goals,
		as well as a roadmap of the features (<span class="text-destructive">which is still a work in progress</span>).
		Please feel free to give me your feedback. Thank you!
	</p>
	<div class="my-10 grid grid-cols-2 gap-10">
		<div class="card">
			...
			<a href={resolve('/projects/flux-studio')} class="clickable mt-3 self-end justify-self-end text-sm">Read More</a>
		</div>
		...
		<div class="card flex flex-col gap-2">
			...
			<a href={resolve('/projects/website')} class="clickable mt-3 self-end justify-self-end text-sm">Read More</a>
		</div>
	</div>
</div>
