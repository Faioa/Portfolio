...
<div class="grid flex-wrap truncate grid-cols-1 md:grid-cols-3 w-full gap-10">
	...
	{:else}
		<p class="col-span-1 md:col-span-3 text-destructive text-center">I'm sorry, but there's no available article yet. Please wait a few days for some content to be published!</p>
	{/each}
</div>
